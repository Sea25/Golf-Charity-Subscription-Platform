    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex justify-between items-center">
            ...
            <div className="flex gap-4">
              <Link href="/login" className="text-gray-600 hover:text-rose-500">
                Sign In
              </Link>
              <Link
                href="/signup"
                className="bg-rose-500 text-white px-5 py-2 rounded-full hover:bg-rose-600"
              >
                Subscribe Now
              </Link>
            </div>
      ...
      <section className="pt-32 pb-20 px-6 bg-gradient-to-br from-rose-50 via-white to-amber-50">
        <div className="max-w-7xl mx-auto text-center">
          <span className="inline-block px-4 py-2 bg-rose-100 text-rose-600 rounded-full text-sm mb-6">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto mb-10">
            ...
            <span className="font-semibold text-rose-500 block mt-2">
              10% of your subscription supports charities you choose.
            </span>
          </p>
          <Link
            href="/signup"
            className="bg-rose-500 text-white px-8 py-3 rounded-full font-semibold hover:bg-rose-600 inline-block shadow-lg"
          >
            Subscribe Now
          </Link>
        </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center p-6">
              ...
              <p className="text-gray-600">
                Choose monthly or yearly plan. 10% goes to charity of your choice.
              </p>
            </div>
            <div className="text-center p-6">
              <div className="w-16 h-16 bg-rose-100 rounded-full flex items-center justify-center mx-auto mb-4 text-2xl">
              ...
              <p className="text-gray-600">
                Submit your latest 5 Stableford scores (1-45 points).
              </p>
            </div>
            <div className="text-center p-6">
              <div className="w-16 h-16 bg-rose-100 rounded-full flex items-center justify-center mx-auto mb-4 text-2xl">
              ...
              <p className="text-gray-600">
                Win cash prizes. Jackpot rolls over if no 5-number match winner.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              When you subscribe, 10% of your fee goes to a charity you choose.
            </p>
          </div>
      ...
      <footer className="bg-gray-900 text-white py-8 px-6">
        <div className="max-w-7xl mx-auto text-center">
          <p className="text-gray-400 text-sm">
            © 2026 IMPACT GOLF. Every subscription gives back.
          </p>
        </div>
      </footer>
    </div>
