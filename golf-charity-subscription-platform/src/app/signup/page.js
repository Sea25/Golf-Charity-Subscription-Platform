    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white flex items-center justify-center px-4">
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8">
          ...
          <h2 className="text-2xl font-semibold text-gray-800 mt-4">Create an Account</h2>
          <p className="text-gray-500 mt-2">Join the movement and start making an impact</p>
        </div>

        {/* Sign Up Form */}
        <form onSubmit={handleSignUp} className="bg-white rounded-2xl shadow-sm p-8">
          {error && (
